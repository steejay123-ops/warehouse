...
- [x] <!-- id: task_axis1_title_badge --> **۱.۲ عنوان، نشان آیکونی گرادیانی و برچسب قلمرو:**
  - ساختار هماهنگ سمت راست با باکس آیکون اختصاصی مربع گرد (`w-10 h-10 rounded-xl flex items-center justify-center text-lg shadow-2xs`).
  - عنوان صفحه بولد با فونت سیستم + برچسب قلمرو اختصاصی «منوی کارمند» با رنگ‌بندی تفکیک‌شده.
