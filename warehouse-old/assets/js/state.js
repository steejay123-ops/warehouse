...
const SYSTEM_PERMISSIONS = {
  execution: {
    title: 'عملیات میدانی و شمارش',
    items: [
      { id: 'can_scan_qr', label: 'اسکن بارکد و لیبل' },
      { id: 'can_submit_count', label: 'ثبت مقدار شمارش شده' },
      { id: 'can_upload_photo', label: 'آپلود عکس کالا' },
      { id: 'can_view_sys_qty', label: 'مشاهده موجودی سیستمی (آپشنال)' }
    ]
  },
  supervision: {
    title: 'نظارت و تاییدات',
    items: [
      { id: 'can_view_discrepancy', label: 'مشاهده وضعیت مغایرت' },
      { id: 'can_request_recount', label: 'درخواست بازشماری' },
      { id: 'can_approve_count', label: 'تایید نهایی شمارش کالا' }
    ]
  },
  documents: {
    title: 'مدارک و مالی',
    items: [
      { id: 'can_edit_financials', label: 'ویرایش مدارک مالی/گمرکی' },
      { id: 'can_approve_docs', label: 'تایید اسناد کالا' }
    ]
  },
  management: {
    title: 'مدیریت سیستم',
    items: [
      { id: 'can_manage_users', label: 'مدیریت کاربران و نقش‌ها' },
      { id: 'can_manage_warehouses', label: 'ایجاد/ویرایش انبارها' },
      { id: 'can_print_labels', label: 'چاپ گروهی لیبل و QR' }
    ]
  }
};

// در متغیر appState.roles فیلد permissions را به شکل زیر اضافه کنید:
// (نمونه یکی از نقش‌ها)
// { id: 'R3', title: 'سرپرست اجرا', parentId: 'R2', color: '#059669', permissions: ['can_view_discrepancy', 'can_request_recount'] }
// ====== EXCEL COLUMNS DEFINITION ======
const DISPATCH_COLUMNS = [
  { key: 'id', label: 'کد سیستم' },
  { key: 'mesc', label: 'کد ۱۲ رقمی (MESC)' },
  { key: 'partNo', label: 'شماره فنی (Part No)' },
  { key: 'desc', label: 'شرح کالا' },
  { key: 'category', label: 'دسته‌بندی' },
  { key: 'loc', label: 'موقعیت فیزیکی' },
  { key: 'qty', label: 'تعداد' },
  { key: 'unit', label: 'واحد' },
  { key: 'cond', label: 'وضعیت' },
  { key: 'remarks', label: 'ملاحظات' },
  { key: 'tag', label: 'برچسب (Tag)' },
  { key: 'assignee', label: 'تیم شمارش' },
  { key: 'status', label: 'وضعیت فاز' }
];
...
let appState = {
  ...
  unit: 'admin',
  tab: 'dashboard',
  activeWarehouseId: 'PRJ-01', // انبار فعال اولیه هنگام ورود
  ...
  // دیتابیس اتمیزه کاربران متصل به سیستم لاگین مرجع شما
  users: [
  ...
  // مجموعه کلان رکوردهای نمونه تفکیک شده بر اساس انبارها جهت مغایرت‌گیری
  records: [
    // --- انبار PRJ-01 (انبار مرکزی گاز شیرین) ---
    ...
    // --- انبار PRJ-02 (انبار شماره ۴ قطعات یدکی) ---
    ...
    // --- انبار PRJ-03 (انبار ابزار دقیق فاز ۱۲) ---
  ...
  drafts: [], tasks: [], changeLogs: [], importLogs: []
};

// ====== DYNAMIC & RESTORED LOGIN USERS DATABASE ======
const usersDatabase = {
  'saman_admin': { password: '123456', role: 'admin', name: 'سامان تقوی سوق', avatar: 'س' },
  'heydari_manager': { password: '123456', role: 'management', name: 'مهندس حیدری', avatar: 'ح' },
  'ghasemi_exec': { password: '123456', role: 'execution', name: 'علی قاسمی', avatar: 'ع' },
  'rezaei_docs': { password: '123456', role: 'documents', name: 'فاطمه رضایی', avatar: 'ف' },
  'karimi_feed': { password: '123456', role: 'feeding', name: 'حسین کریمی', avatar: 'ه' }
};